...
<table border="1" align="center">
    ...
    <tr>
        <th>Nombres</th><td colspan="2"><?= $cliente->getNombres() ?> <?= $cliente->getApellidos() ?></td><th>Identificacion</th><td colspan="2"><?= $cliente->getIdentificacion() ?></td>
    </tr>
    <tr>
        <th>Teléfono</th><td colspan="2"><?= $cliente->getTelefono() ?></td><th>Correo Electrónico</th><td colspan="2"><?= $cliente->getCorreoElectronico() ?></td>
    </tr>
</table>
<br>
