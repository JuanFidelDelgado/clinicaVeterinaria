...
insert into estadoHidratacion (hidratacion) values ('Normal'), ('Deshidratado 0.0% - 5.0%'), ('Deshidratado 5.0% - 7.0%'), ('Deshidratado 7.0% - 9.0%'), ('Deshidratado 9.0% - 10.0%'), ('Deshidratados mayor a 10.0%');
...
insert into usuario (tipoUsuario, identificacion, tipoIdentificacion, nombres, apellidos, telefono, direccion, correoElectronico, clave, tarjetaProfesional) values ('M','2000','1','Sara Sofia','Delgado Gómez','310000000','Calle 1 # 11 - 91','sara@empresa.com',md5('2000'),'123456');
insert into usuario (tipoUsuario, identificacion, tipoIdentificacion, nombres, apellidos, telefono, direccion, correoElectronico, clave, tarjetaProfesional) values ('S','3000','1','Laboratorio clinico','','310000000','Calle 1 # 11 - 91','laboratorio@empresa.com',md5('3000'),'');
insert into usuario (tipoUsuario, identificacion, tipoIdentificacion, nombres, apellidos, telefono, direccion, correoElectronico, clave, tarjetaProfesional) values ('C','4000','1','Owen Sebastián','Martínez Martínez','310000000','Calle 1 # 11 - 91','owen@empresa.com',md5('4000'),'');
